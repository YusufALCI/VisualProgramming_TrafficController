...
public class TrafficController {
    ...
    private void setupButtonActions() {
        view.getBaslatButon().setOnAction(e -> {
        ...
        view.getDuraklatButon().setOnAction(e -> pauseSimulation());
        view.getDurdurButon().setOnAction(e -> stopSimulation());
    }
    ...
    private void startSimulation() {
        ...
        int northCount = parseCount(view.getKuzeyAracSayisi());
        int southCount = parseCount(view.getGuneyAracSayisi());
        int westCount = parseCount(view.getBatiAracSayisi());
        int eastCount = parseCount(view.getDoguAracSayisi());
    ...
    private void updateLightColors() {
        view.getKuzeyIsik().setFill(model.getNorthLightColor());
        view.getGuneyIsik().setFill(model.getSouthLightColor());
        view.getBatiIsık().setFill(model.getWestLightColor());
        view.getDoguIsik().setFill(model.getEastLightColor());
    }

    private void updateTimerTexts() {
        int timerValue = model.getTimer();
        view.getKuzeySayac().setText(String.valueOf(timerValue));
        view.getGuneySayac().setText(String.valueOf(timerValue));
        view.getBatiSayac().setText(String.valueOf(timerValue));
        view.getDoguSayac().setText(String.valueOf(timerValue));
    }
